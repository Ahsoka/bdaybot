...
class HelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        if not ctx.guild:
            help_embed.set_footer(text=(
                ...
                f"Use {ctx.prefix}help in server with me to see all the available commands!"
            ))
    ...
    async def send_command_help(self, command):
        ...
        if command.name == 'wish':
            ...
            description =  (
                "The getID command allows you to determine the ID that corresponds with your Discord account. "
            ...
            try:
                ...
                description = "**CURRENTLY UNAVAILABLE BECAUSE I DO NOT HAVE THE MANAGE MESSAGES PERMISSION**\n\n"
            description += (
                "The setID command allows you to set the ID that corresponds with your Discord account. "
            ...
            try:
                ...
                description = "**UNAVAILABLE IN DM MESSAGES**\n\n"
            description += (
                "The setannouncements command allows you to set the text channel which I will announce the birthdays in.\n\n"
            ...
            command_embed = discord.Embed(description=description) \
                .set_author(name="Setannouncements Command", icon_url=await EmojiURLs.loudspeaker) \
            ...
            try:
                ...
                description = '**UNAVAILABLE IN DM MESSAGES**\n\n'
            description += (
                "The getannouncements command shows you the current channel I use to announce whose birthday it is.\n\n"
            ...
            command_embed = discord.Embed(description=description) \
                .set_author(name="Getannouncements Command", icon_url=await EmojiURLs.loudspeaker) \
            ...
            command_embed = discord.Embed(description=description) \
                .set_author(name="Upcoming Command", icon_url=await EmojiURLs.calendar) \
            ...
            try:
                ...
                description = '**UNAVAILABLE IN DM MESSAGES**\n\n'
            description += (
                "The wishes command shows you all the wishes someone has received.\n\n"
